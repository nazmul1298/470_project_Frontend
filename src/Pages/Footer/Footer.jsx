import './Footer.css';
import footerImage from '../../../public/photos/footer5.svg';
import footerImage2 from '../../../public/photos/MusicSchool_Logo.png';

const Footer = () => {
    return (
        <footer className="footer p-10 bg-base-600 text-cyan-500 footerimg pt-32 pl-52 text-xl" style={{ backgroundImage: `url(${footerImage})`, backgroundRepeat: 'no-repeat', backgroundSize: '100% auto', backgroundPosition: 'center top -120px' }}>
            <div>
                <img className=' w-72' src={footerImage2} alt="" />
                <p className=' pl-10'>Providing Music Camp Since 1992</p>
            </div>
            <div>
